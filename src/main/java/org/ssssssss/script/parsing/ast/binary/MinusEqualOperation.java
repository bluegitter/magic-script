...
public class MinusEqualOperation extends BinaryOperation {
	...
	public MinusEqualOperation(Expression leftOperand, Span span, Expression rightOperand) {
	...
	public Object evaluate(MagicScriptContext context, Scope scope) {
		...
		if (left instanceof Double || right instanceof Double) {
			...
			value = ObjectConvertExtension.asDecimal(left).subtract(ObjectConvertExtension.asDecimal(right));
