...
public class BitHandle {
	...
	public static Object left_shift_fallback(Object a, Object b) {
		return reject(a, b, "<<");
	}
	...
	public static Object right_shift_fallback(Object a, Object b) {
		return reject(a, b, ">>");
	}
	...
	public static Object right_shift2_fallback(Object a, Object b) {
		return reject(a, b, ">>>");
	}
